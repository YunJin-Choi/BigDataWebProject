	...
	<div class="menu" id="home" style="display: block">
		...
		<div class="w3-row w3-container">
			...
			<div class="w3-col l3 m6 w3-light-grey w3-container w3-padding-16"
				style="height: 200px">
				<h3>Marketer Board</h3>
				<br>
				<p>for active information exchange and communication among
					marketers</p>
			</div>
			...
			<div class="w3-col l3 m6 w3-dark-grey w3-container w3-padding-16"
				style="height: 200px">
				<h3 style="color: white">Trend Information</h3>
				<br>
				<p style="color: white">for providing domestic and global
					marketing trend information</p>
			</div>
			<div class="w3-col l3 m6 w3-black w3-container w3-padding-16"
				style="height: 200px">
				<h3 style="color: white">Recommendation</h3>
				<br>
				<p style="color: white">for recommending the best marketing
					method based on our data</p>
			</div>
		</div>
		<!-- intro 끝 -->
		...
		<div class="w3-row w3-container">
			<div class="w3-center w3-padding-64">
				<span
					class="w3-xlarge w3-bottombar w3-border-dark-grey w3-padding-16">About
					Us</span>
			</div>
			...
			<div class="w3-row-padding w3-grayscale" style="margin-left: 1.5%">
				...
				<div class="w3-col l3 m6 w3-margin-bottom">
					<img src="images/p3.JPG" alt="Yunjin"
						style="width: 300px; height: 200px"> <br>
					<br>
					<h3>
						<font face="verdana">Choi Yunjin</font>
					</h3>
					<br>
					<p class="w3-opacity">
						<font face="verdana">Computer Engineering</font>
					</p>
					<p style="width: 300px; height: 80px">
						<font face="verdana">I am a team leader of our project and
							I have professional skill in this field. </font>
					</p>
					<p>
						<a href="https://accounts.google.com"><button
								class="w3-button w3-light-grey w3-block" style="width: 300px">
								<font face="verdana">Contact</font>
							</button></a>
					</p>
				</div>
				...
				<div class="w3-col l3 m6 w3-margin-bottom">
					<img src="images/p4.JPG" alt="Eunyong"
						style="width: 300px; height: 200px"> <br>
					<br>
					<h3>
						<font face="verdana">Lee Eunyong</font>
					</h3>
					<br>
					<p class="w3-opacity">
						<font face="verdana">Industrial engineering</font>
					</p>
					<p style="width: 300px; height: 80px">
						<font face="verdana">I have higher concentration when doing
							our project and I always smile:)</font>
					</p>
					<p>
						<a href="https://accounts.google.com"><button
								class="w3-button w3-light-grey w3-block" style="width: 300px">
				...
				<div class="w3-col l3 m6 w3-margin-bottom">
					<img src="images/p2.JPG" alt="Miso"
						style="width: 300px; height: 200px"> <br>
					<br>
					<h3>
						<font face="verdana">Kim Miso</font>
					</h3>
					<br>
					<p class="w3-opacity">
						<font face="verdana">Statistics</font>
					</p>
					<p style="height: 80px">
						<font face="verdana">I am only female in our team and I am
							good at designing web-site and have cooperation mind.</font>
					</p>
					<p>
						<a href="https://accounts.google.com"><button
								class="w3-button w3-light-grey w3-block" style="width: 300px">
				...
				<div class="w3-col l3 m6 w3-margin-bottom">
					<img src="images/p1.JPG" alt="Jeon"
						style="width: 300px; height: 200px"> <br>
					<br>
					<h3>
						<font face="verdana">Jeon hyunjun</font>
					</h3>
					<br>
					<p class="w3-opacity">
						<font face="verdana">Environmental engineering</font>
					</p>
					<p style="height: 80px">
						<font face="verdana">Although My major is environmental
							engineering, I am interested in IT and have various IT knowledge.
						</font>
					</p>
					<p>
						<a href="https://accounts.google.com"><button
		...
		<div class="w3-row w3-container">
			<div class="w3-center w3-padding-64">
				<span
					class="w3-xlarge w3-bottombar w3-border-dark-grey w3-padding-16">Useful
					Page</span>
			</div>
			<center>
				<iframe src="http://www.usmarketingcorp.com/" display:block margin:0
					auto height="500" width="900" style="border: 5px solid grey;">
				</iframe>
			</center>
		</div>
		<!-- 유용한 페이지 End -->
				...
				<div class="row">
					<div class="col-md-4 to-animate">
						<h3 class="section-title">
							<font face="verdana">About Us</font>
						</h3>
						<br>
						<p>
							Kdata 빅데이터 청년인재 1기 <br>3-days web-project
						</p>
						<p class="copy-right">
							&copy; 2017 Kdata <br> All Rights Reserved by my Team <br>
		...
		<div class="modal" id="id01">
			<div class="modal-content animate" id="login">
				...
				<div class="containerLogin">
					<label><b>Email</b></label> <input class="inputForm" type="text"
			...
			<div class="modal-content animate" id="join">
				...
				<div class="containerLogin">
					<label><b>Email</b></label> <input class="inputForm" type="text"
						placeholder="Enter Email" name="email"> <label><b>Password</b></label>
					<input class="inputForm" type="password"
						placeholder="Enter Password" name="password1"> <label><b>Password
							Confirm</b></label> <input class="inputForm" type="password"
						placeholder="Enter Password" name="password2"> <label><b>Nick
							Name</b></label> <input class="inputForm" type="text"
						placeholder="Enter Nick Name" name="nickname"> <label><b>Call
							Number</b></label> <input class="inputForm" type="tel"
						placeholder="Enter Call Number" name="callnumber" maxlength="11">
					<center>
						<input type="radio" name="job" value="marketer">Marketer <input
							type="radio" name="job" value="owner">Owner
					</center>
