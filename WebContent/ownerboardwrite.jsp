...
<table class="boardTable" align="center" style="width: 70%">
	<tr><td class="boardtd" align="center">제목
...
<tr>
		<td align="right"><button class="w3-button w3-black" onclick="return ownererrorCheck()">글쓰기</button>
		<input class="w3-button w3-black" type="reset" value="다시 쓰기">
		<input	class="w3-button w3-black" type="button" value="리스트로 돌아가기" onclick="ownerboardList()"></td>
	</tr>
</table>
</center>
</form>
